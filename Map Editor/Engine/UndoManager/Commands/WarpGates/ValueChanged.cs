...
namespace Map_Editor.Engine.Commands.WarpGates
{
    ...
    /// Value Changed class.
    /// </summary>
    public class ValueChanged : WarpGate, ICommand
    {
        /// <summary>
        ...
        public void Undo()
        {
            ...
            Object.Entry.WarpID = OldValue.WarpID;
            ...
            if (ToolManager.GetToolMode() == ToolManager.ToolMode.WarpGates && MapManager.WarpGates.Tool.SelectedObject == ObjectID)
                ((WarpGateTool)App.Form.ToolHost.Content).Select(ObjectID);
        }
        ...
        public void Redo()
        {
            ...
            Object.Entry.WarpID = NewValue.WarpID;
        ...
        {
            return "Warp Gate - Value Changed";
        }
    }
}